...
import { extractTime } from "../extractime/extracTime";

const ChatItem = ({ currentUserId, senderId, receiverId, message, createdAt}) => {
  ...
  return (
    <View style={{ flex: 1, margin: 10, alignItems: alignStyle }}>
      ...
      <Text style={{ fontSize: 15, fontStyle: "italic", color: "black", padding:8 }}>
        {formattedTime}
      </Text>
    </View>
  );
